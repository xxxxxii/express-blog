      ...
      <el-form ref="params" :model="params" label-width="90px">
        <div v-show="activeIndex == 0" v-loading="loading">
            ...
            <el-col :sm="24" :md="12">
              <el-form-item label="内容属性">
                <el-checkbox-group v-model="params.attr" @change="handleAttr">
                  <el-checkbox value="1">头条</el-checkbox>
                  <el-checkbox value="2">推荐</el-checkbox>
                  <el-checkbox value="3">轮播</el-checkbox>
                  <el-checkbox value="4">热门</el-checkbox>
                </el-checkbox-group>
              </el-form-item>
            </el-col>
          ...
          <el-form-item label="文章内容">
            <!-- <vue3-tinymce v-model="params.content" :setting="setting" @init="tinymce" -->
            <!-- script-src="/public/admin/tinymce/tinymce.min.js" /> -->
            <md-editor v-model="params.content" @init="tinymce"></md-editor>
          </el-form-item>
